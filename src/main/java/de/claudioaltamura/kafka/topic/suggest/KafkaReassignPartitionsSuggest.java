...
public class KafkaReassignPartitionsSuggest {
  ...
  public static void main(String[] args) throws IOException {
    ...
    int[] partitionLeader = {2, 3, 0, 2, 3, 0, 2, 3, 0, 2, 3, 0, 2, 3, 0, 2, 3, 0, 2, 3, 0, 2, 3, 0,
        2, 3, 0, 2, 3, 0, 2, 3, 0, 2, 3, 0, 2, 3, 0, 2, 3, 0, 2, 3, 0, 2, 3, 0, 2, 3};
    int[] brokerIds = {0, 1, 2, 3, 4};

    KafkaReassignPartitionsSuggestController controller =
        new KafkaReassignPartitionsSuggestController();
    KafkaReassignPartitions kafkaReassignPartitions = controller
        .process(topic, paritionsCount, replicationFactor, partitionLeader, brokerIds);
    KafkaReassignPartitionsWriter writer =
        new KafkaReassignPartitionsWriter();
